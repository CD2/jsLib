...
export class Accordion extends React.Component {
  ...
  @computed get getOpen() {
    return this.props.open !== null ? this.props.open : this.open
  }
  ...
  render() {
    ...
    return (
      <div className={this.props.className}>
        ...
        <div className={`accordion__content ${this.getOpen ? `accordion__content--open`: ``}`}>
          {this.getOpen ? this.props.children : null}
        </div>
      </div>
    )
  }
